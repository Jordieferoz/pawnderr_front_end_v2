...
const Settings: FC = () => {
    ...
    const handleBack = () => {
        if (step !== 0 && window.innerWidth < 768) {
            setStep(0);
        } else {
            // Unfortunately ProfileHeader's back logic is tied to router or redux
            // We might need to override it or wrap it.
            // Actually ProfileHeader uses router.back() for desktop, and for mobile if step != 0 it dispatches redux.
            // Wait, ProfileHeader is coupled to Redux. I should check ProfileHeader again.
        }
    };
