...
const MOCK_NOTIFICATIONS = [
  ...
  },
  {
    ...
    type: "promo",
    title:
      "Pawnderr+: Congratulations! You have a New offer. Get 30% off on Pawnderr+.",
    time: "Today",
    read: false,
        ...
        <div className="overflow-y-auto p-4 flex flex-col gap-4">
          {notifications.length === 0 ? (
            ...
            notifications.map((notification) => (
              <div
                key={notification.id}
                className={`flex gap-3 p-3 rounded-xl transition-colors ${notification.read ? "bg-white" : "bg-blue-50/50"}`}
              >
                <img
